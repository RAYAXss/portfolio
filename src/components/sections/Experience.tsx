    ...
    <section id="experience" className="py-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeInOnScroll>
          ...
          <div className="w-12 h-0.5 bg-gradient-to-r from-blue-400 to-purple-400 mx-auto mb-12 rounded-full" />
        </FadeInOnScroll>
                  ...
                  <div className="relative flex gap-8">
                    ...
                    <div className="hidden md:flex flex-col items-center">
                      <motion.div
                        ...
                        className="w-10 h-10 rounded-full bg-gray-950 border-2 border-blue-500 flex items-center justify-center mt-1 flex-shrink-0 z-10"
                      >
                    ...
                    <motion.div
                      ...
                      className="flex-1 bg-gray-900/60 border border-gray-800 hover:border-blue-500/40 rounded-xl overflow-hidden transition-colors cursor-pointer"
                    ...
                    >
                      <div className="p-5">
                        ...
                        <div className="mb-4">
                          ...
                          <h4 className="text-sm text-blue-400 mb-3">{exp.company}</h4>
                          <div className="flex flex-wrap gap-3 text-xs text-gray-500">
                            ...
                            <span className="px-2.5 py-0.5 bg-blue-900/40 text-blue-300 border border-blue-800/60 rounded-full font-medium">
                              {exp.contractType}
                            </span>
                          </div>
                        </div>
